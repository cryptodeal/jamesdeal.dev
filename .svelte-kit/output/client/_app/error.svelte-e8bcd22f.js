...
function v(s) {
	...
	return {
		...
		l(t) {
			...
			var p = n(E);
			(g = c(p, $)), p.forEach(u), (x = m(t)), j && j.l(t), (P = d());
		},
		m(s, t) {
			p(s, r, t), f(r, a), p(s, v, t), p(s, E, t), f(E, g), p(s, x, t), j && j.m(s, t), p(s, P, t);
		},
		p(s, [r]) {
			1 & r && l(a, s[0]),
				2 & r && $ !== ($ = s[1].message + '') && l(g, $),
		...
		o: h,
		d(s) {
			s && u(r), s && u(v), s && u(E), s && u(x), j && j.d(s), s && u(P);
		}
	};
}
