<script>
  ...
  import {titles, content} from '$lib/about/_ResumeContent'
</script>
<svelte:head>
  <title>My Resume - James Deal</title>
  <meta name="description" content="Academic and professional experience, skills, and interests.">
...
<div class="grid auto-rows-min break-words grid-cols-1 my-5 h-full mx-10 py-5 rounded-lg gap-2 bg-opacity-80 bg-blue-300 dark:(bg-purple-900 bg-opacity-30) md:(gap-4 grid-cols-2 mx-20) lg:mx-30 xl:mx-40 2xl:mx-60">
  <SectionTitle title={titles.edu} />
  ...
  <SectionTitle title={titles.stack}/>
  <div class='text-center'>
    <Subtitle title={content.stack.frontend.subtitle}/>
    <BulletedList bulletItems={content.stack.frontend.list}/>
    <Subtitle title={content.stack.backend.subtitle}/>
    <BulletedList bulletItems={content.stack.backend.list}/>
  </div>

  <SectionTitle title={titles.exp} />
  <div class='text-center'>
    <Subtitle title={content.exp.uw.subtitle.title} href={content.exp.uw.subtitle.href} role={content.exp.uw.subtitle.role} />
    <Dates dates={content.exp.uw.dates} />
    <BulletedList bulletItems={content.exp.uw.info} />

    <Subtitle title={content.exp.reyReyPSC.subtitle.title} href={content.exp.reyReyPSC.subtitle.href} role={content.exp.reyReyPSC.subtitle.role} />
    <Dates dates={content.exp.reyReyPSC.dates} />
    <BulletedList bulletItems={content.exp.reyReyPSC.info} />

    <Subtitle title={content.exp.coss.subtitle.title} href={content.exp.coss.subtitle.href} role={content.exp.coss.subtitle.role} />
    <Dates dates={content.exp.coss.dates} />
    <BulletedList bulletItems={content.exp.coss.info} />

    <Subtitle title={content.exp.reyReyIT.subtitle.title} href={content.exp.reyReyIT.subtitle.href} role={content.exp.reyReyIT.subtitle.role} />
