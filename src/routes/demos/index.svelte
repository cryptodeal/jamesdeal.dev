...
<h1 class="font-light font-sans my-5 text-center text-5xl text-red-800 break-words md:text-7xl dark:text-green-400">Demos</h1>
<div class="flex mb-5">
	<nav class="mx-auto h-8 gap-20 inline-flex">
		...
		<h2 class="font-extralight font-sans text-2xl text-red-800 self-center lg:text-4xl dark:text-green-400">Data Viz</h2>
		<svg
			xmlns="http://www.w3.org/2000/svg"
			on:click={nextChart}
			class="cursor-pointer h-8 fill-current stroke-none w-auto text-red-800 dark:text-green-400"
