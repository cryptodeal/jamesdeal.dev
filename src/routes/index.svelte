...
<section class="container mx-auto my-3 p-5 md:mt-10 lg:mt-20">
		...
		>
			...
			<div class="flex-1 mb-2 inline-flex items-center">
				<svg
					...
					class="h-6 stroke-current mr-3 text-red-800 w-6 dark:text-green-400"
					fill="none"
					viewBox="0 0 24 24"
				>
					<path
			...
			<div>
				<p>
					Specializing in full-stack development, with a focus on building light-weight front end
					applications (SPA, Static, PWA, SSR) using Svelte powered by high throughput APIs
					(REST/Websocket) using <a href="https://github.com/nanoexpress/nanoexpress">NanoExpress</a
					>, which provides an Express-like wrapper, as well as many other invaluable utilities, to
					the <a href="https://github.com/uNetworking/uWebSockets.js/">µWebSockets.js</a> library. The
					µWebSockets.js library, in turn, provides node.js bindings to µWebSockets, a server written
					in C# with kernel level performance optimizations.
				</p>
				<p>
					By utilizing NanoExpress, the APIs backing my applications have proven, in testing,
					capable of scaling to <a href="https://web-frameworks-benchmark.netlify.app/result"
						>150,000+ Requests/Second</a
					>
					and sustaining
					<a
						href="https://alexhultman.medium.com/millions-of-active-websockets-with-node-js-7dc575746a01"
						>over 1 million</a
					> active websocket connections per each instance of the server.
				</p>
				<div class="flex inline-flex" />
				<a class="flex-1 gap-3 no-underline inline-flex items-center" title="twitter" href="/about">
					<h4
						class="font-extralight font-sans text-lg text-red-800 lg:text-2xl dark:text-green-400"
					>
						Résumé
					</h4>
					<svg
		...
		>
			...
			<div>
				<p>
					...
					development, with a focus on building light-weight front end applications (SPA/Static,
					PWA, SSR) using Svelte and backend frameworks that leverage a server written in C++ with
					node.js bindings for performance. My applications utilize both REST and Websocket API.
				</p>
			</div>
		</div>
		<div class="mx-auto my-5 w-98">
	...
	<div class="flex flex-col w-full text-red-800 justify-center dark:text-green-400">
		...
		<div class="flex mx-auto inline-flex">
			...
			<a class="px-2 no-underline" title="github" href="https://github.com/cryptodeal">
				<svg
					class="h-10 fill-current w-auto"
					xmlns="http://www.w3.org/2000/svg"
					width="24"
