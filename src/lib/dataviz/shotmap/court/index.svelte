<script>
	...
	$: rimCenterX = $width / 2;
	$: rimCenterY =
		config.backboardDistanceFromBaseline * scaleRatio +
		config.rimDistanceFromBackboard * scaleRatio +
		rimRadius;
	//backboard variables
	...
	$: restrictedAreaY =
		backboardY + config.rimDistanceFromBackboard * scaleRatio + config.rimRadius * scaleRatio;
</script>

<g
	fill="none"
	class="stroke-gray-800 dark:stroke-gray-200"
	transform="rotate(180 {reverseWidth} {reverseHeight})"
>
	...
	<path
		d="M{ftCircleArchX1} {ftCircleArchY} A{ftCircleArchRadius} {ftCircleArchRadius} 0 0 1 {ftCircleArchX2} {ftCircleArchY}"
		stroke-dasharray={ftCircleArchLowGap}
	/>
	<!--drawing the high free throw circle arch-->
	<path
		d="M{ftCircleArchX1} {ftCircleArchY} A{ftCircleArchRadius} {ftCircleArchRadius} 0 0 0 {ftCircleArchX2} {ftCircleArchY}"
	/>
	<!--drawing the half court circle-->
	<path
		d="M{hcCircleX1} {$height} A{hcCircleRadius} {hcCircleRadius} 0 0 1 {hcCircleX2} {$height}Z"
	/>
	<!--drawing the restrain circle-->
	<path
		d="M{restrainCircleX1} {$height} A{restrainCircleRadius} {restrainCircleRadius} 0 0 1 {restrainCircleX2} {$height}Z"
	/>
	<!--drawing the three point line-->
	<path
		d="M{threePointLineX1} 0 {threePointLineX1} {threePointLineY2} A{threePointLineRadius} {threePointLineRadius} 0 0 0 {threePointLineX2} {threePointLineY2} L{threePointLineX2} 0Z"
	/>
	<!--drawing the restricted area-->
	<path
		d="M{restrictedAreaX1} {restrictedAreaY} A{restrictedAreaRadius} {restrictedAreaRadius} 0 0 0 {restrictedAreaX2} {restrictedAreaY}"
	/>
</g>
